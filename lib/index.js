...
var Parse = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        type = (_a.sent()).type;
                        this.type = type;
                        targetPath = (0, utils_1.findPath)(this.targetDir);
                        (0, utils_1.emptyTheMkdir)(targetPath);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_1.hasTableName)(tableNames, function () { return __awaiter(_this, void 0, void 0, function () {
                                var structure, _a, collect, base_name, columnStructure;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, (0, parser_1.getTableStructure)(tableNames)];
                                        case 1:
                                            structure = _b.sent();
                                            _a = (0, utils_1.baseEntity)(), collect = _a.collect, base_name = _a.base_name;
                                            columnStructure = (0, parser_1.transformStructure)(structure, collect);
                                            // 生成实体类
                                            (0, parser_1.generateEntity)(columnStructure, this.targetPath, base_name);
                                            return [2 /*return*/];
                                    }
                                });
                            }); })];
                                    ...
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Promise.all(tableNames.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            (0, utils_1.emptyTheMkdir)((0, path_1.join)(this.targetPath, 'controllers'));
                                                            (0, utils_1.emptyTheMkdir)((0, path_1.join)(this.targetPath, 'services'));
                                                            childCollectPath = {
                                                                controllers: (0, path_1.join)(this.targetPath, 'controllers', name),
                                                                services: (0, path_1.join)(this.targetPath, 'services', name),
                                                            };
                                                            (0, utils_1.emptyTheMkdir)(childCollectPath.controllers);
                                                            (0, utils_1.emptyTheMkdir)(childCollectPath.services);
                                                            return [4 /*yield*/, this.generateEntity()];
                                                        case 1:
                                                            _a.sent();
                                                            options = { table: { table_name: name } };
                                                            (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.CONTROLLER, options, childCollectPath);
                                                            (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.SERVICE, options, childCollectPath);
                                                            return [2 /*return*/];
                                                    }
                                                });
                                            }); }))];
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            _a.sent();
                                                            options = { table: { table_name: name } };
                                                            (0, genFiles_1.genFiles)(types_1.GENFILE_TYPES.FULL, options, childCollectPath);
                                                            return [2 /*return*/];
                                                    }
                                                });
                                            }); }))];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, this.generateWithEntity()];
                    case 1:
                        // await this.generateCURD();
                        _a.sent();
                        return [2 /*return*/];
    ...
    // 综合方法: 生成除实体类
    Parse.prototype.generateWithEntity = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tableNames;
            var _this = this;
            return __generator(this, function (_a) {
