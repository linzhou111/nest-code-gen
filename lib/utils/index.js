...
var findPath = function (dirName) {
    ...
    if (resultPath) {
        ...
        if (dirName === 'src') {
            ...
            (0, exports.emptyTheMkdir)(resultPath);
            return resultPath;
        }
        else {
            throw new ReferenceError("The folder ".concat(dirName, " was not found"));
        }
    }
};
...
var readYMLConfig = function (field) {
    ...
    if (dir.includes('code-gen.yml')) {
        try {
            var file = (0, fs_2.readFileSync)((0, path_1.join)(path, 'code-gen.yml'), 'utf8');
...
var baseEntity = function () {
     ...
     */
    var _a = (0, exports.readYMLConfig)('data_config') || {}, _b = _a.base_name, base_name = _b === void 0 ? '' : _b, _c = _a.collect, collect = _c === void 0 ? '' : _c;
